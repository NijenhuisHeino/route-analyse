...
namespace Postnl.RouteAnalyse.Fast.Endpoints;

public static class FastApiEndpoints
{
    public static IEndpointRouteBuilder MapFastApi(this IEndpointRouteBuilder endpoints, string prefix)
    {

...
{
    private readonly string _root = Path.Combine(Path.GetTempPath(), "postnl-fast-csv-tests", Guid.NewGuid().ToString("N"));

    [Fact]
    public async Task OriginalMonthlyCsvsAreMaterializedIntoFastCache()
    {
